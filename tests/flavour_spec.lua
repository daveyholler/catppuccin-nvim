...
describe("change flavour to", function()
	...
	it("horizon", function()
		vim.cmd.colorscheme "catppuccin-horizon"
		assert.equals("catppuccin-horizon", vim.g.colors_name)
	end)
end)
...
describe("respect setup flavour =", function()
	...
	it("horizon", function()
		require("catppuccin").setup { flavour = "horizon" }
		vim.cmd.colorscheme "catppuccin"
		assert.equals("catppuccin-horizon", vim.g.colors_name)
	end)
end)
...
describe("(deprecated) respect vim.g.catppuccin_flavour =", function()
	...
	it("horizon", function()
		vim.g.catppuccin_flavour = "horizon"
		vim.cmd.colorscheme "catppuccin"
		assert.equals("catppuccin-horizon", vim.g.colors_name)
	end)
end)
